-- labs/bug-tombstone — 2 entities. Applied to D1 oat-labs-bug-tombstone.
...
CREATE TABLE IF NOT EXISTS "stores" ("id" TEXT PRIMARY KEY, "org_id" TEXT NOT NULL, "name" TEXT, "status" TEXT, "position" INTEGER, "note" TEXT, "kind" TEXT, "product_count" INTEGER, "created_at" INTEGER, "updated_at" INTEGER, "deleted_at" INTEGER);
